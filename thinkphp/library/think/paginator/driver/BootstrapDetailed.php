...
class BootstrapDetailed extends Paginator
{
    ...
    {
        $page = $this->options['var_page'];
        $html = <<<HTML
<li class="pull-left" style="margin-left: 10px;"><form>
<input type="text" style="width:80px;height:34px;outline: none;padding-left: 2px;border-radius: 3px;border:1px solid #ccc;" autocomplete="off" name="$page" placeholder="请选择页数">
