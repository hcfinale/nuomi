<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:51:"E:\www\nuomi./application/bis\view\login\index.html";i:1527152180;s:53:"E:\www\nuomi./application/bis\view\public\header.html";i:1527237737;s:53:"E:\www\nuomi./application/bis\view\public\footer.html";i:1527219733;}*/ ?>
<!--包含头部文件-->
<!DOCTYPE HTML>
<html>
<head>
...
<div class="loginWraper">
  <div id="loginform" class="loginBox">
    <form class="form form-horizontal" action="<?php echo url('login/index'); ?>" method="post">
      <div class="row cl">
        <label class="form-label col-xs-3"><i class="Hui-iconfont">账户：</i></label>
